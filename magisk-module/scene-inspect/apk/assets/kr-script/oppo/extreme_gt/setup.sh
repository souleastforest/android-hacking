...
HighTemperatureDisableFlashChargeLimit=440
HighTemperatureEnableFlashChargeLimit=430
...
do
  ...
  while read line; do
     ...
     *'"battery.temperate.range":'*)
       echo '"battery.temperate.range": "[100,450]",' >> $module$file
     ;;
     *'"high.capacity.battery.temperate.range":'*)
       echo '"high.capacity.battery.temperate.range": "[100,450]",' >> $module$file
     ;;
